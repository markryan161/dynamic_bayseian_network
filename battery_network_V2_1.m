...
for i = 1:total_cycles
    ...
    if i == 1
        ...
        % Calc. P(Deg_t-1)
         ...
         [marginal_pdf, ~] = multi_KDE_V3(samples);
...
result = A_matrix ./ b_vector; % [d × 1]
conditional_pdf = (sum(result)/sum(result(:)))';
end
