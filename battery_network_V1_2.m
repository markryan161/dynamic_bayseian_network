%% V1_2 Battery Network - Up to 10000 Cycles
...
for i = 1:total_cycles
    ...
    if i == 1
        ...
        [marginal_pdf, ~] = multi_KDE(charge_proposal_particles);
        ...
        [marginal_pdf, marginal_evaluation_points] = multi_KDE(conditional_temp_particles);
